...
class DataCollatorForMultipleChoice:
    ...
    def __call__(self, features):
        ...
        labels = [self.label_dic[feature.pop(label_name)]for feature in features]
...
def main():
    ...
    ending_names = [f"choice_{i}" for i in ["a", "b", "c", "d"]]
    ...
    def preprocess_function(examples):
        ...
        ids = examples["id"]
        second_sentences = [
            [f"{examples[end][i]}" for end in ending_names] for i, _ in enumerate(ids)
        ]
